...
<body>
<h1><center><b><u>Infrastructure Report</u></b></center></h1>
	...
	<table class="table table-striped">
			<tr>
			<th>SL NO</th> <th>USN</th> <th>Student Name</th><th>Course</th><th>Semester</th><th>Chair</th><th>Casing</th>
			<th>Tables</th><th>Other Due</th><th>Amount</th><th>Other Due</th><th>Amount</th><th>Other Due</th><th>Amount</th><th>Total Amount</th>
			</tr>
			<?php
	
	$sub1 = mysqli_query($conn,"select * from infra");
	if($sub1)
{
	...
	<td> <?php echo $row['chair']; ?> </td>
		<input type="hidden" value="<?php echo $row['chair']; ?>" name="course[]" />
		<td> <?php echo $row['casing']; ?> </td>
		<input type="hidden" value="<?php echo $row['casing']; ?>" name="course[]" />
		<td> <?php echo $row['tables']; ?> </td>
		<input type="hidden" value="<?php echo $row['tables']; ?>" name="course[]" />
...
<h1><center><b><u>Infrastructure Report</u></b></center></h1>
	...
	$cid=$_POST['class_id'];
	$sub = mysqli_query($conn,"select * from infra where class_id = '$cid'");
	if($sub)
{
...
<form action="infra_report.php" method="post">
