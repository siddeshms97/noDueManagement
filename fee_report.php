...
<body>
<h1><center><b><u>Fee Report</u></b></center></h1>
	...
	<table class="table table-striped">
			<tr>
			<th>SL NO</th> <th>USN</th> <th>Student Name</th><th>Course</th><th>Semester</th><th>Tuition Fee</th><th>Exam Fee</th>
			<th>Other Due</th><th>Amount</th><th>Other Due</th><th>Amount</th><th>Other Due</th><th>Amount</th><th>Total Amount</th>
			</tr>
			<?php
	
	$sub1 = mysqli_query($conn,"select * from fee");
	if($sub1)
{
	...
	<td> <?php echo $row['tutfee']; ?> </td>
		<input type="hidden" value="<?php echo $row['tutfee']; ?>" name="course[]" />
		<td> <?php echo $row['examfee']; ?> </td>
		<input type="hidden" value="<?php echo $row['examfee']; ?>" name="course[]" />
...
<h1><center><b><u>Fees Report</u></b></center></h1>
	<div class="panel panel-default">
	<div class="panel panel-heading">
		<!--<a href="report.php"><button type="button" value="Back" class="btn btn-default pull-left" />Back </button></a>-->
	<h1>
	...
	$cid=$_POST['class_id'];
	$sub = mysqli_query($conn,"select * from fee where class_id = '$cid'");
	if($sub)
{
...
<form action="fee_report.php" method="post">
